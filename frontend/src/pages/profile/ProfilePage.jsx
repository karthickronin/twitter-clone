...
import { formatPostDate } from "../../utils/data/formatPostDate";
...
const ProfilePage = () => {
  ...
  const { updateProfile, isUpdating } = useEditProfile(FormData)
  ...
  const memberSinceDate = formatPostDate(user?.createdAt);
            ...
            <>
              ...
              <div className="relative group/cover">
                <img
                  ...
                  alt={coverImg || user?.coverImg || "/cover.png"}
                />
                {isMyProfile && (
                  <div
